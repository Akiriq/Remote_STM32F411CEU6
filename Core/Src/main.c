...
/* Definitions for send_usb_data */
osThreadId_t send_usb_dataHandle;
const osThreadAttr_t send_usb_data_attributes = {
  .name = "send_usb_data",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for read_nrf */
osThreadId_t read_nrfHandle;
const osThreadAttr_t read_nrf_attributes = {
  .name = "read_nrf",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal1,
};
/* Definitions for send_nrf */
osThreadId_t send_nrfHandle;
const osThreadAttr_t send_nrf_attributes = {
  .name = "send_nrf",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_send_usb_data_func */
/**
* @brief Function implementing the send_usb_data thread.
* @param argument: Not used
* @retval None
*/
...
void send_usb_data_func(void *argument)
{
  ...
  /* USER CODE END send_usb_data_func */
}

/* USER CODE BEGIN Header_read_nrf_func */
/**
* @brief Function implementing the read_nrf thread.
* @param argument: Not used
* @retval None
*/
...
void read_nrf_func(void *argument)
{
  ...
  /* USER CODE END read_nrf_func */
}

/* USER CODE BEGIN Header_send_nrf_func */
/**
* @brief Function implementing the send_nrf thread.
* @param argument: Not used
* @retval None
*/
